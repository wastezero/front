(**
  MIT License
  Copyright (c) 2019 Alexander P Chang

  Vendored from https://github.com/alexchang8/bs-big.js
*)
...
external fromStringExn: string -> t = "default" [@@bs.new] [@@bs.module "./big.js"]

let fromString s =
  try_wrap (fun () -> fromStringExn s) "[big.js] Invalid number" Invalid_number

external fromFloat: float -> t = "default" [@@bs.new] [@@bs.module "./big.js"]

external fromInt: int -> t = "default" [@@bs.new] [@@bs.module "./big.js"]

external bigJsObj: big = "default" [@@bs.val] [@@bs.module "./big.js"]
